...
var roomTable = (function(_Component) {
	...
	function roomTable() {
		...
		var _this = _possibleConstructorReturn(
			this,
			(roomTable.__proto__ || Object.getPrototypeOf(roomTable)).call(this)
		);
			...
			value: function renderTableData() {
				return this.state.rooms.map(function(room, index) {
					...
					return React.createElement(
						...
						React.createElement("td", null, roomName),
						React.createElement("td", null, pNumb),
				...
				return React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement("tr", null, "Room Name"),
							React.createElement("tr", null, "Number of players"),
							React.createElement("tr", null, "State")
						),
